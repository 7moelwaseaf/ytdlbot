...
# quota settings
QUOTA = int(os.getenv("QUOTA", 10 * 1024 * 1024 * 1024))  # 5G
if os.uname().sysname == "Darwin":
    QUOTA = 10 * 1024 * 1024  # 10M

TG_MAX_SIZE = 10 * 1024 * 1024 * 1024 * 0.99
...
MAX_DURATION = int(os.getenv("MAX_DURATION", 160))
